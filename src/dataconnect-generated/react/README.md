...
export default function GetSkillsComponent() {
  ...
  const query = useGetSkills({ limit: ..., });
...
export default function CreateUserComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ clerkId: ..., email: ..., username: ..., image: ..., });
...
export default function CreateSkillComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ authorId: ..., title: ..., description: ..., tags: ..., installCommand: ..., promptConfig: ..., usageExample: ..., });
